...
interface OrphanageDataPosition {
  position:{
    latitude:number;
    longitude:number;
  }
...
export default function OrphanageData() {
  ...
  const params = route.params as OrphanageDataPosition;
  ...
  async function handleSelectImgs() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
      ...
      <TextInput
        ...
        // onChangeText ={text => setName(text)} pode ser usado assim tbm, porem mais verboso
      />
      ...
      <TouchableOpacity style={styles.imagesInput} onPress={handleSelectImgs}>
